...
CHAN = "#queenlisatheloli"                               # Channelname = #{Nickname}
NICK = "queenlisatheloli"                         # Nickname = Twitch username
PASS = "oauth:xgjplp491vlgviegj91fjm259ytife"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
