...
CHAN = "#peachyy_x3"                               # Channelname = #{Nickname}
NICK = "peachyy_x3"                         # Nickname = Twitch username
PASS = "oauth:j060d2wju7mgm316hwa04pbltwlbce   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
