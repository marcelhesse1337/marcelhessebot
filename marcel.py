...
CHAN = "#lea_peachyy"                               # Channelname = #{Nickname}
NICK = "lea_peachyy"                         # Nickname = Twitch username
PASS = "oauth:gfleyru0wev2y6zo8ob158jwav5dpt"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
