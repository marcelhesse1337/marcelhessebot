...
CHAN = "#treywaytv"                               # Channelname = #{Nickname}
NICK = "treywaytv"                         # Nickname = Twitch username
PASS = "oauth:h9oh2q277ym8mg5aerwasrrcc2hxgm"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
