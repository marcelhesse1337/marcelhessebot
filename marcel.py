...
CHAN = "#klisadrawsyourdick"                               # Channelname = #{Nickname}
NICK = "lisadrawsyourdick"                         # Nickname = Twitch username
PASS = "oauth:zdlt15ov0joydjc9dklxgt6y7lyrxn"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
