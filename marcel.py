...
CHAN = "#Sophieee_Cosplay"                               # Channelname = #{Nickname}
NICK = "Sophieee_Cosplay"                         # Nickname = Twitch username
PASS = "oauth:lr8wultb7kgbjh5z0bjx143kk0qrx4"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
