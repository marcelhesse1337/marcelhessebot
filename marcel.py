...
CHAN = "#celinecookiequeen"                               # Channelname = #{Nickname}
NICK = "celinecookiequeen"                         # Nickname = Twitch username
PASS = "oauth:kaq02dhhqf9l7wl202mqqg8y9sgad6"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
