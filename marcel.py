...
CHAN = "#lillyhasnotits"                               # Channelname = #{Nickname}
NICK = "lillyhasnotits"                         # Nickname = Twitch username
PASS = "oauth:cd977zjd63plgoi6ckdkfjrcvm9v6d"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
