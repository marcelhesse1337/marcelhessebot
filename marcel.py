...
CHAN = "#kawaiisxphie"                               # Channelname = #{Nickname}
NICK = "kawaiisxphie"                         # Nickname = Twitch username
PASS = "oauth:jos89zza4qm7onzdvjgvvwpwn12zhm"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
