...
CHAN = "#ehrenmango"                               # Channelname = #{Nickname}
NICK = "ehrenmango"                         # Nickname = Twitch username
PASS = "oauth:mcnxpj0eti7ortepshlir7953odix7"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
