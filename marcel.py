...
CHAN = "#sophielikestosucc"                               # Channelname = #{Nickname}
NICK = "sophielikestosucc"                         # Nickname = Twitch username
PASS = "oauth:weyi1biwhwcr9jc607t2cpswo1vkvw"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
