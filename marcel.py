...
CHAN = "#LewdLisa_x3"                               # Channelname = #{Nickname}
NICK = "LewdLisa_x3"                         # Nickname = Twitch username
#PASS = "oauth:ho32sxo3jq2bi3nygtc2w05mshee0k"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
