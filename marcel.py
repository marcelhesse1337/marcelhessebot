...
CHAN = "#lisaaaa_tv"                               # Channelname = #{Nickname}
NICK = "lisaaaa_tv"                         # Nickname = Twitch username
PASS = "oauth:gyxty9tq3mfots8av2spjt1xdootyf"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
