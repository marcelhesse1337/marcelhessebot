...
CHAN = "#poklimane"                               # Channelname = #{Nickname}
NICK = "poklimane"                         # Nickname = Twitch username
PASS = "oauth:z14bitrdodox6kgnfkghcbdss8yr6i"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
