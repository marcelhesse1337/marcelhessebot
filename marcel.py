...
CHAN = "#LisasCandyWorld"                               # Channelname = #{Nickname}
NICK = "LisasCandyWorld"                         # Nickname = Twitch username
#PASS = "oauth:ry6m76bfz02hn2se74zoxak2iqaybp"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
