...
CHAN = "#SophieSnowy"                               # Channelname = #{Nickname}
NICK = "SophieSnowy"                         # Nickname = Twitch username
#PASS = "oauth:1bsu35muu14gdvbxm517qcpx0mue13"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
