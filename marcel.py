...
CHAN = "#lisaatv_"                               # Channelname = #{Nickname}
NICK = "lisaatv_"                         # Nickname = Twitch username
PASS = "oauth:vzhm51nifl2xuk60temq2mvbbetn1n"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
