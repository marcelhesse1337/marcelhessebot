...
CHAN = "#lisathelewdest"                               # Channelname = #{Nickname}
NICK = "lisathelewdest"                         # Nickname = Twitch username
PASS = "oauth:x86eu6jjiic30khbq6p7htawl8n3xh"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
