...
CHAN = "#princesscatpaw"                               # Channelname = #{Nickname}
NICK = "princesscatpaw"                         # Nickname = Twitch username
PASS = "oauth:od4sbf4ge8imvv90xnv8zd3p86i347"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
