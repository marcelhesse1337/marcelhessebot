...
CHAN = "#chloescookieworld"                               # Channelname = #{Nickname}
NICK = "chloescookieworld"                         # Nickname = Twitch username
PASS = "oauth:8st3muwqg4wc3im7z9zikfnfgupznp"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
