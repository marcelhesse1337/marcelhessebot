...
CHAN = "#kellykawaii_x3"                               # Channelname = #{Nickname}
NICK = "kellykawaii_x3"                         # Nickname = Twitch username
#PASS = "oauth:4dlukw3imk02g3tw0j039q50zkm95j"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
