...
CHAN = "#kati3streams"                               # Channelname = #{Nickname}
NICK = "kati3streams"                         # Nickname = Twitch username
PASS = "oauth:ndtostzehzqo2ln2desjf6rkx39ak9"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
