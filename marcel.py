...
CHAN = "#Jokela_High_School"                               # Channelname = #{Nickname}
NICK = "Jokela_High_School"                         # Nickname = Twitch username
PASS = "oauth:lw8tzg9gaullniaoqxi5ldam7hdg9v"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
