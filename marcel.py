...
CHAN = "#lisa_the_goat"                               # Channelname = #{Nickname}
NICK = "lisa_the_goat"                         # Nickname = Twitch username
PASS = "oauth:al55z87bs02c2b4ux177gcwzhhb1xv"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
