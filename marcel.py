...
CHAN = "#sophiesadness"                               # Channelname = #{Nickname}
NICK = "sophiesadness"                         # Nickname = Twitch username
PASS = "oauth:4hn8wyegus0kxjj3og5gt4lyazoria"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
