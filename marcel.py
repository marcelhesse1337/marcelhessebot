...
CHAN = "#lenaaa_x33"                               # Channelname = #{Nickname}
NICK = "lenaaa_x33"                         # Nickname = Twitch username
PASS = "oauth:vpvl4mj2x2rogdhip6pn957yat1za7"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
