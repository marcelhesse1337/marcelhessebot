...
CHAN = "#princeesslilly"                               # Channelname = #{Nickname}
NICK = "princeesslilly"                         # Nickname = Twitch username
PASS = "oauth:bjrznvb94blzx2tv480ph7ry9blewc"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
