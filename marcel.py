...
CHAN = "#Sxphie_x3"                               # Channelname = #{Nickname}
NICK = "Sxphie_x3"                         # Nickname = Twitch username
#PASS = "oauth:3yxa8ykkhme6l0gjjjgfbxh5zus3gl"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
