...
CHAN = "#melina_celina"                               # Channelname = #{Nickname}
NICK = "melina_celina"                         # Nickname = Twitch username
PASS = "oauth:z75qvcyppubsfwa2i3ykczi949w1ep"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
