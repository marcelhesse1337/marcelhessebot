...
CHAN = "#lisatheloli"                               # Channelname = #{Nickname}
NICK = "lisatheloli"                         # Nickname = Twitch username
PASS = "oauth:hhwfdwezej304xmsdasp0x4xyin7ih"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
