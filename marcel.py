...
CHAN = "#princesssxphie"                               # Channelname = #{Nickname}
NICK = "princesssxphie"                         # Nickname = Twitch username
#PASS = "oauth:nhd6ent0ez43idhffjgra8yyceahqp"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
