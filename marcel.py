...
CHAN = "#internetxprincess"                               # Channelname = #{Nickname}
NICK = "internetxprincess"                         # Nickname = Twitch username
PASS = "oauth:zzial6sgwb0aexzzfze0ci25pztvtm"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
