...
CHAN = "#AmyCandyLand"                               # Channelname = #{Nickname}
NICK = "AmyCandyLand"                         # Nickname = Twitch username
PASS = "oauth:k99icmlw1i3fz7dvw1fbln2h3gt38i"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
