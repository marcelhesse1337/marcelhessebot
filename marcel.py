...
CHAN = "#lisaprincess_x3"                               # Channelname = #{Nickname}
NICK = "lisaprincess_x3"                         # Nickname = Twitch username
PASS = "oauth:hkr3vahawyaw1y9m6nlnzzkoewztvi"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
