...
CHAN = "#pokilmane"                               # Channelname = #{Nickname}
NICK = "pokilmane"                         # Nickname = Twitch username
PASS = "oauth:ggo3wx54jvyj2c4knu4ri9hs4mf4y8"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
