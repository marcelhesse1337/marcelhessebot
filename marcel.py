...
CHAN = "#kawaiisophie_x3"                               # Channelname = #{Nickname}
NICK = "kawaiisophie_x3"                         # Nickname = Twitch username
PASS = "oauth:9dapty92cvlqt5gzjkhenfn1x8pxdw"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
