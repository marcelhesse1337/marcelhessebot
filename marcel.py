...
CHAN = "#QueenLisa666"                               # Channelname = #{Nickname}
NICK = "QueenLisa666"                         # Nickname = Twitch username
#PASS = "oauth:59ogtl9dtrmbj03ljfmpy0y7veadn1"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
